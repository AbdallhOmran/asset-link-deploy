...
import { NewBookingModalComponent } from './pages/bookings/components/new-booking-modal/new-booking-modal.component'; // ✅ import واحد بس
...
@NgModule({
  declarations: [
    ...
    NewBookingModalComponent, // ✅ declaration واحدة بس
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
